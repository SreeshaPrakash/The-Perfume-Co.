...
//     } catch (error) {
//         console.error(error)
//         res.redirect("/pageerror, occured in editProduct")
...
const editProduct = async (req, res) => {
    try {
        ...
        const files = [req.body.image1, req.body.image2, req.body.image3, req.body.image4];
        console.log(files);
        ...
        const brandId = mongoose.Types.ObjectId.isValid(data.brand) ? new mongoose.Types.ObjectId(data.brand) : product.brand;
        const categoryId = mongoose.Types.ObjectId.isValid(data.category) ? new mongoose.Types.ObjectId(data.category) : product.category;
